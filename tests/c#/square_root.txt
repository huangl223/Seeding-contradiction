...
namespace ICTSS_Test
{
    public class SquareRoot
    {
        ...
        public (int, int) square_root(int n)
        {  //TUPLE[root1: INTEGER; root2: INTEGER]
            //require
...
class Program
{
    static void Main(string[] args)
    {
        ...
        squareRoot = new SquareRoot();
        valueTuple = squareRoot.square_root(0);

        // test 3
        // ValueTuple<int, int> valueTuple;
        squareRoot = new SquareRoot();
        valueTuple = squareRoot.square_root(13);

        // test 4
        squareRoot = new SquareRoot();
        valueTuple = squareRoot.square_root(4);

        // test 5
        squareRoot = new SquareRoot();
        valueTuple = squareRoot.square_root(6);
