...
class Program
{
    static void Main(string[] args)
    {
        ...
        int i;
        arithmetic = new Arithmetic();
        i = arithmetic.add(0, 0);

        // test 3
        arithmetic = new Arithmetic();
        i = arithmetic.add(0, -92);

        // test 4
        arithmetic = new Arithmetic();
        i = arithmetic.add(0, 4);

        // test 5
        arithmetic = new Arithmetic();
        i = arithmetic.add_recursive(0, 0);

        //test 6
        arithmetic = new Arithmetic();
        i = arithmetic.add_recursive(36, 8);

        //test 7
        arithmetic = new Arithmetic();
        i = arithmetic.add_recursive(36, -96);
        ...
        //test 9
        arithmetic = new Arithmetic();
        valueTuple = arithmetic.divide(101, 1);

        //test 10
        arithmetic = new Arithmetic();
        valueTuple = arithmetic.divide_recursive(0, 1);

        // test 11
        arithmetic = new Arithmetic();
        valueTuple = arithmetic.divide_recursive(3, 1);

        // test 12
        arithmetic = new Arithmetic();
        i = arithmetic.multiply(0, 0);

        // test 13
        arithmetic = new Arithmetic();
        i = arithmetic.multiply(10, 0);

        // test 14
        arithmetic = new Arithmetic();
        i = arithmetic.multiply(10, 1);

        //test 15
        arithmetic = new Arithmetic();
        i = arithmetic.multiply(10, 2);

        // test 16
        arithmetic = new Arithmetic();
        i = arithmetic.multiply(-6, 2);

        //test 17
        arithmetic = new Arithmetic();
        i = arithmetic.multiply(-6, 8);

        // test 18
        arithmetic = new Arithmetic();
        i = arithmetic.multiply(1, 8);

        // test 19
        arithmetic = new Arithmetic();
        i = arithmetic.multiply_recursive(0, 0);

        // test 20
        arithmetic = new Arithmetic();
        i = arithmetic.multiply_recursive(10, 0);

        // test 21
        arithmetic = new Arithmetic();
        i = arithmetic.multiply_recursive(10, 1);

        // test 22
        arithmetic = new Arithmetic();
        i = arithmetic.multiply_recursive(1, 2);

        // test 23
        arithmetic = new Arithmetic();
        i = arithmetic.multiply_recursive(-6, 2);

        //test 24
        arithmetic = new Arithmetic();
        i = arithmetic.multiply_recursive(10, 9);

        // test 25
        arithmetic = new Arithmetic();
        i = arithmetic.multiply_recursive(-6, 9);
