...
feature -- Basic operations
	...
	linear_search (a: SIMPLE_ARRAY [INTEGER]; value: INTEGER): INTEGER
		...
		require
			array_size: 1 <= a.count and a.count <= 20 and True and True and True and True and True and True and True and True and True
		do
...
--			if Result = a.count and not (a [Result] = value) then
--				Result := Result + 1
--			end
		ensure
			result_in_bound: 1 <= Result and Result <= a.count + 1
