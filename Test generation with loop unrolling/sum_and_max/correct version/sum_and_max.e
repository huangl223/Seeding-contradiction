...
feature
	...
	sum_and_max (a: SIMPLE_ARRAY [INTEGER]): TUPLE [sum, max: INTEGER]
		...
		require
			a_not_void: a /= Void
			natural_numbers: across 1 |..| a.count as ai all (a.sequence [ai] >= 0 and a.sequence [ai] <= 10) end
			array_not_empty: a.count > 0
			array_size_limit: a.count <= 20 and True and True and True and True and True and True and True and True and True and True
		local
			i: INTEGER
			sum, max: INTEGER
		do
