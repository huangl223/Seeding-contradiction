...
feature
	...
	sum_and_max (a: SIMPLE_ARRAY [INTEGER]): INTEGER
			-- Index of maximum element of `a'.
		require
			a_element_value_limit: across 1 |..| a.count as i all a.sequence [i] >= -100 and a.sequence [i] <= 100 end
			a_not_empty: a.count > 0 and a.count <= 20 and True and True and True and True and True and True and True and True and True
		local
			x, y: INTEGER
		do
			from
